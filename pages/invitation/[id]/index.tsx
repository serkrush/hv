...
import UserForm, { UserInteractMode } from '@/src/components/Form/UserForm';
...
export default function Base() {
    ...
    const invitationConfirmed = useMemo(() => {
        const confirmation = flagger[Flag.InviteConfirmedSuccess];
